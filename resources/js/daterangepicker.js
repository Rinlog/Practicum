...
import $ from 'jquery';
    ...
    var DateRangePicker = function(element, options, cb) {
        ...
        this.buttonClasses = '';
        this.applyClass = 'bg-white border-2 border-[#46c0e5] p-3 rounded-full text-[#46c0e5] font-semibold hover:text-[#3c8fb0] hover:border-[#3c8fb0] cursor-pointer';
        this.cancelClass = 'text-gray-500 hover:bg-gray-200 p-3 rounded-full cursor-pointer';
    ...
    <div class="daterangepicker dropdown-menu w-full max-w-4xl mx-auto p-4 bg-white shadow-lg rounded-md overflow-auto">
        ...
        if (typeof options.ranges === 'object') {
            ...
            var list = '<ul>';
            list+='<h2 class="text-[#00719d] font-semibold pt-4 pb-4 whitespace-nowrap">DATE RANGE</h2>'
    ...
    DateRangePicker.prototype = {
        ...
        hide: function(e) {
            ...
            this.container.hide();
            this.container.removeClass("flex");
