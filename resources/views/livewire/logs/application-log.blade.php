<div id="MainWindowLogs" class="flex flex-col lg:flex-row w-full max-w-[1750px] gap-0">
    ...
    <div class="relative w-full lg:flex-1 pl-10 pr-10">
    <div class="lg:p-10 md:p-10 pb-15 pr-10 pl-2 pt-2 bg-white shadow-md flex flex-col gap-2 rounded-b-lg min-h-[1530px] w-full md:min-h-[781px] lg:min-h-[750px] overflow-y-hidden">
        <div id="ApplicationSelector" class="w-full flex items-center">
                ...
                <div class="selectWrapperLG w-[67.5%]">
                    <select id="Applications" class="open-sans-soft-regular border-r-1 border-t-1 border-b-1 border-gray-300 border-solid bg-[#707070] w-full text-white text-lg hover:bg-[#4a4a4a] p-6 pr-10 rounded-r-lg font-bold shadow-md">
