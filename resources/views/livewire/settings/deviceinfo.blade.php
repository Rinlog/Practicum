<div id="MainWindowSettings" class="flex flex-col lg:flex-row lg:w-[1750px] gap-10">
        ...
        <table class="rounded-lg border-2 border-[#f4f4f4] border-separate w-full block overflow-y-auto overflow-x-auto border-spacing-[0]">
            ...
            <tbody id="InfoTable" class="bg-white rounded-lg">
                    ...
                    <td id="LoadingIcon" class="relative align-center h-[220px] hide" colspan="999" wire:loading.class.remove="hide">
                        <span class="absolute top-[35%] left-[16%]" wire:loading>
    ...
    <div id="AddMenu" class="hide relative transition-all duration-100">
        ...
        <form>
            <div id="AddDevice" class="pt-24 pb-30 relative bg-[#00719d] z-1 pl-10 pt-1 pr-3 mt-22 text-white h-[645px] rounded-lg w-[400px] overflow-x-visible overflow-y-scroll">
                    ...
                    <div class="mt-2 w-[90%] border-b-2 border-[#32a3cf] ">
                        <label class="text-lg">Device Types:</label>
                        <select id="type" class="w-full pl-2">
                            @foreach($deviceTypeInfo as $deviceType)
                                <option class="bg-gray-500" id={{ $deviceType->device_type_id }}>{{ $deviceType->device_type }}</option>
                            @endforeach
                        </select>
                    </div>
    ...
    <div id="EditMenu" class="hide relative transition-all duration-100">
        ...
        <div class="text-white bg-[#00719d] z-2 top-29 rounded-t-lg absolute w-[383px] h-[120px] text-start pl-10">
        ...
        <script>
            ...
            function ValidateIfUnique(EUI,EUIName, Mode){
                ...
                $("#InfoTable").children().each(function(index){
                    if ($(this).children()[3] !== undefined && $(this).children()[2] !== undefined){
            ...
            function ShowLoading(){
                ...
                LoadingTD.html(
                    "<span class=\"absolute top-[35%] left-[16%]\" wire:loading colspan=\"999\"><img src=\"/images/Loading_2.gif\"></span>"
                )
