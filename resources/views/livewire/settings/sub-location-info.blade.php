<div id="MainWindowSettings" class="flex flex-col lg:flex-row lg:w-[1750px] gap-10">
    ...
    <div class="flex">
        <div class="relative inline-block text-left w-full pr-4 lg:pr-0 md:pr-0">
            <div id="OrganizationSelector" class="w-full flex items-center md:flex-row lg:flex-row flex-col">
    ...
    <div class="lg:p-10 md:p-10 pb-15 pr-10 pl-2 pt-2 bg-white shadow-md mt-8 rounded-lg h-screen md:h-[645px] lg:h-[645px]">
        <span class="flex items-center justify-between mb-4">
            ...
            <span class="flex gap-4 items-center">
                <label class="text-[#1c648c] font-semibold text-3xl">Sub Location Information </label>
    ...
    <div id="AddMenu" class="hide relative transition-all duration-100">
        ...
        <form>
            <div id="AddLocation" class="pt-24 pb-30 relative bg-[#00719d] z-1 pl-10 pt-1 pr-3 mt-22 text-white h-[645px] rounded-lg w-[400px] overflow-x-visible overflow-y-scroll">
                    <livewire:components.req-underline-input id="locationName" placeholder="Sub-Location Name" type="text"></livewire:components.req-underline-input>
                    ...
                    <livewire:components.underline-input id="floor" placeholder="Floor" type="text"></livewire:components.underline-input>
    ...
    <livewire:alert.notification key="{{ Str::random() }}"></livewire:alert.notification>
        ...
        <script>
                ...
                if (e.target.checked){
                    ...
                    for (let i = 0; i < CheckBoxes.length; i++){
                        if (CheckBoxes[i].checked == false){
                            ...
                            let obj = $(CheckBoxes[i].parentNode.parentNode).children()[5].textContent;
            ...
            function ValidateIfUnique(Item1, Mode){
                ...
                if (Mode == "add"){
                    if (Item1DupeCount >= 1 ){
                        return "This Sub Location already exists";
                    }
                }
                else if (Mode == "edit"){
                    if (Item1DupeCount > 1 ){
            ...
            $js("AddConfirm",function(e){
                ...
                $("#InfoTable").append(tr);
                setAlertText("Successfully added Sub Location");
                displayAlert();
                closeAddMenu()
            });
            ...
            function PopulateArrayWithVals(EditAdd){
                ...
                FormVals.push($(`#${EditAdd} #floor`).val());
            ...
            $js("EditConfirm",function(e){
                ...
                $("#"+SpaceToUnderScore(EditItem)).children().each(function(index){
                    //we exclude the checkbox, sequence num, exclude org name,Sub Location id
                    if (index >=5){
                ...
                if (Result != ""){
                    ...
                    setAlertText("Successfully updated Sub Location");
                    displayAlert();
                    closeEditMenu();
                }
            });
            ...
            $js("CloseOpenEdit",function(){
                ...
                if (EditMenuStatus == false){
                    ...
                    $("#EditLocation #locationName").val(Obj["SUB-LOCATION NAME"]);
                    $("#EditLocation #civicAddress").val(Obj["CIVIC ADDRESS"]);
                    $("#EditLocation #floor").val(Obj["FLOOR"]);
            ...
            $js("OpenDeleteModal",async function(){
                ...
                let name = $("#"+SpaceToUnderScore(ItemsSelected[0])).children()[5].innerHTML;
                if (ItemsSelected.length == 1){
            ...
            async function refresh(){
                ...
                $("#ConfirmDelete").click(function(e){
                    ...
                    setAlertText("Successfully deleted Sub Location(s)");
                    displayAlert();
                });
                closeAddMenu();
                closeEditMenu();
                    ...
                    try{
                        if (Type.includes("UPDATE")){
                            if (Result[index] == 0){
                                ...
                                ErrorMsg += "Failed to update Sub Location \"" + Obj["LOCATION NAME"] + "\"<br>";
                            }
                        }
                            ...
                            if (Result[index] != true){
                                Errors = true;
                                let Obj = JSON.parse(ItemInfo);
                                ErrorMsg += "Failed to insert Sub Location \"" + Obj["LOCATION NAME"] + "\"<br>";
                            }
                        }
                        else if (Type.includes("DELETE")){
                            if (Result[index] == 0){
                                Errors = true;
                                ErrorMsg += "Failed to delete Sub Location(s) " + ItemInfo + "<br>";
                            }
                        }
                    }
                    catch(ex){
            ...
            $js("DownloadCSV",async function(){
                if (TableObjects.length != 0){
                    let result = exportToCsv("SubLocationInfo.csv",TableObjects);
