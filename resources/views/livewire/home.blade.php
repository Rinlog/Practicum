...
<div class="bg-[#f2f2f2] flex flex-row">
    ...
    <div class="w-screen flex flex-col flex-wrap max-h-[890px]">
        ...
        <div class="sm:p-10 min-h-screen lg:min-h-[857px] sm:grid sm:grid-cols-2 grid-rows-5 sm:gap-x-10 sm:gap-x-20">
            ...
            <div class="sm:col-1 row-span-2">
                <h1 class="text-gray-500">Overview</h1>

                <div class="flex sm:flex-row flex-col gap-5 py-5 h-full">
                    ...
                    <div id="RecentLogs" class="bg-white sm:p-10 w-[50%] rounded-lg shadow-md flex flex-col items-start max-h-[140%] min-h-[140%]">
                        @if ($Perms["read"] == true)
                            ...
                            <span class="p-2 flex sm:w-full justify-end items-end">
            ...
            <div class="sm:col-2 row-span-full bg-white p-10 w-[90%] rounded-lg shadow-md">
