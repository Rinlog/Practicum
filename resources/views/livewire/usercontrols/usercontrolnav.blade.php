    ...
    <div>
        <div class="inline-block text-left">
            <div id="UserControlDiv" class="transition-all duration-300 pr-10">
                <button type="button" id="OpenUserControls" class="inline-flex w-full justify-center items-center gap-x-1.5 rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 hover:bg-gray-100" id="menu-button" aria-expanded="true" aria-haspopup="true">
