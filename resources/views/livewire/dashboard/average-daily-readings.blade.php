<div>
    {{-- Search Options --}}
    <div class="fixed lg:w-[16%] lg:h-full lg:top-15 overflow-y-scroll bottom-5 h-[35%] w-[90%] right-0 bg-[#f9f9f9] lg:bg-white p-4 shadow-md z-2"]>
        {{-- DatePicker --}}
        ...
        <script>
            ...
            $js("DownloadCSV",async function(){
                if (TableObjects.length != 0){
                    let result = exportToCsv("DailySensorReadingInfo.csv",TableObjects);
